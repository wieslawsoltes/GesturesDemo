...
namespace Avalonia.Input
{
    ...
    public class PinchToZoomGestureRecognizer : StyledElement, IGestureRecognizer
    {
        ...
        public static readonly RoutedEvent<PinchToZoomGestureEventArgs> PinchToZoomEvent =
            RoutedEvent.Register<PinchToZoomGestureEventArgs>(
                "PinchToZoomEvent", RoutingStrategies.Bubble, typeof(PinchToZoomGestureRecognizer));
